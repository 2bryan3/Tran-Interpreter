...
public class Parser1ExtraTests {
    @Test
    public void testInterface() throws Exception {
        ...
        tokens.add(new Token(Token.TokenTypes.WORD, 2, 20,"n"));
        tokens.add(new Token(Token.TokenTypes.COMMA, 2, 22));
        tokens.add(new Token(Token.TokenTypes.WORD, 2, 23,"number"));
        tokens.add(new Token(Token.TokenTypes.WORD, 2, 28,"n"));
        tokens.add(new Token(Token.TokenTypes.RPAREN, 2, 28));
        tokens.add(new Token(Token.TokenTypes.NEWLINE, 2, 30));
        tokens.add(new Token(Token.TokenTypes.NEWLINE, 2, 30));
        tokens.add(new Token(Token.TokenTypes.NEWLINE, 2, 30));
        tokens.add(new Token(Token.TokenTypes.NEWLINE, 2, 30));
        tokens.add(new Token(Token.TokenTypes.NEWLINE, 2, 30));
        ...
        tokens.add(new Token(Token.TokenTypes.COMMA, 2, 21));
        tokens.add(new Token(Token.TokenTypes.WORD, 2, 22,"number"));
        tokens.add(new Token(Token.TokenTypes.WORD, 2, 29,"n"));
        tokens.add(new Token(Token.TokenTypes.DEDENT, 4, 30));
